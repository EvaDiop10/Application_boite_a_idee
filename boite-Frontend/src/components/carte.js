...
const Carte = (props) => { 
    ...
    const ApprouveHandle = ()=>{
        axios.patch(`http://localhost:3000/idee/${idee.id}`, {statut:true})
        .then( () => console.log("ok"))

    }
    const RefuseHandle = ()=>{
        axios.patch(`http://localhost:3000/idee/${idee.id}`,{statut:false})
        .then(()=>console.log("ok"))
    }
        ...
        <div className='Carte col-6'>
            <div class ="d-flex  justify-content-between mt-5  rounded-3 shadow-lg ">
                <div className="card-body ">
                    ...
                    <h6 className="card-subtitle mb-2 " >Approuvé/refusé</h6>
